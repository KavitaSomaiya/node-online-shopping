        ...
        <div class="container-fluid">
          ...
          <div class='row no-gutters my-4 my-sm-4 my-md-4 my-lg-4 my-xl-4' id='backHtmlImg'>
            <div class='col-2 col-sm-2 col-md-3 col-lg-2 col-xl-2'>
              <div>
                <div class='backHtmlImgClass' onclick="goToItemDetail('${item._id}');">
            ...
            <div class='col-8 col-sm-8 col-md-8 col-lg-9 col-xl-9 px-1'>
              <div class='d-flex flex-column' id='productDesc2'>
                <div>
                  <h1 class onclick="goToItemDetail('${item._id}');">
                    ${item.name}
...
function goToItemDetail (id) {
  console.log(id)
  const itemDetailPath = `./item-details.html?${id}`
  console.log(itemDetailPath)
  window.location.href = itemDetailPath
  window.focus()
}
...
//   let itm = parseInt(it)
//   let curItem = productData.filter(i => i.dataNumber === itm)
//   console.log(curItem)
